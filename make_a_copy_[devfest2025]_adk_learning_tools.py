# -*- coding: utf-8 -*-
"""MAKE_A_COPY_[DevFest2025]_ADK_Learning_tools.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1pmqcuh0T51B-Mtf5opQ6w3g34pVsjrIe
...
def get_live_weather_forecast(location: str) -> dict:
    """Gets the current, real-time weather forecast for a specified location in the US.AIzaSyBTkbMu4s1HW2qupEGOI8lIEuqfXYUMz_0
